...
export const metadata: Metadata = {
  title: "Social Media",
  description: "My social media channels and how to connect with me.",
};
    ...
    <section className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-inside list-disc space-y-1">
          <li>
            <a
              href="https://www.youtube.com/channel/UC1TFhtGkXG007uixYrI_21w"
          ...
          <li>
            <a
              href="https://github.com/SiriusAlpha96"
              className="text-primary hover:underline"
            >
              GitHub
            </a>
          ...
          <li>
            <a
              href="https://www.linkedin.com/in/shreya-maurya-sirius/"
              className="text-primary hover:underline"
            >
              LinkedIn
            </a>
          ...
          <li>
            <a 
            href="https://leetcode.com/u/SHREYA_MAURYA/"
            className="text-primary hover:underline"
            >
              LeetCode
            </a>
          ...
          <li>
            <a
            href="https://www.hackerrank.com/profile/mshreya63068"
            className="text-primary hover:underline"
            >
              HackerRank
            </a>
